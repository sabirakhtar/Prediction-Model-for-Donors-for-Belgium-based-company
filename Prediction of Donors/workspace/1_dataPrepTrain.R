...
campaign_train <- read_delim("C:/Users/user/Downloads/IESEG Studies/Descriptive  Predictive Analytics/Prediction of Donors/data/campaign20130411.csv", 
                             ";", escape_double = FALSE, trim_ws = TRUE)

# Read the donors data
donors <- read_delim("C:/Users/user/Downloads/IESEG Studies/Descriptive  Predictive Analytics/Prediction of Donors/datadonors.csv", 
                     ";", escape_double = FALSE, na = "Missing", 
                     trim_ws = TRUE)

# Read the gifts data
gifts <- read_delim("C:/Users/user/Downloads/IESEG Studies/Descriptive  Predictive Analytics/Prediction of Donors/datagifts.csv", 
